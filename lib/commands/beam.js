...
On the sending device:
  ...
  cat hello.txt | gnostr-hyp beam "for bob roberts"

On the receiving device:

  gnostr-hyp beam "for bob roberts" > ./hello.txt

This can be really useful for sharing hyper keys between devices. For instance:

  > gnostr-hyp sync ./my-folder
  ...
  > echo "hyper://f7145e1bbc0d17705861e996b47422e0ca50a80db9441249bd721ff426b79f2a/" \\
    | gnostr-hyp beam "nobody can guess"
`
...
export default {
  ...
  command: async function (args) {
    const phrase = args._[0] ? args._.join(' ') : randomWords(3).join(' ')
