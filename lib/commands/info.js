...
Examples:
  ...
  gnostr-hyp info
  gnostr-hyp info --live
  gnostr-hyp info hyper://1234..af/
  gnostr-hyp info hyper://1234..af/ hyper://fedc..21/
`
...
export default {
  ...
  command: async function (args) {
    ...
    if (!useLiveOutput && args.live) {
      console.error('Cannot pipe output of "gnostr-hyp info" with --live set, disabling live-mode.')
      args.live = false
    }
    ...
    if (!keys.length) {
      console.log(`No gnostr-hyps active.`)
      process.exit(0)
    }
