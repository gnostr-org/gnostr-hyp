...
Examples:
  ...
  gnostr-hyp bee ls hyper://1234..af/
  gnostr-hyp bee ls hyper://1234..af/foo/bar
  gnostr-hyp bee ls hyper://1234..af/ --gte a --lt m
`
...
export default {
  ...
  command: async function (args) {
    ...
    const res = await listShallow(bee.api, urlp.pathname || '/')
